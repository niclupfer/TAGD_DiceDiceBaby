...
{
    public ChatView chats;

    public override void OnReceivedBroadcast(string fromAddress, string data)
    {
        //GetComponent<LobbyMaster>().ConnectClient(fromAddress);
        chats.AddMessage(0, "broadcast: " + fromAddress + " data: " + data);
...
namespace UnityEngine.Networking
{
    ...
    public class NetworkDiscovery : MonoBehaviour
    {
        ...
        {
            Debug.Log("net discover - starting as client");
        ...
        {
            Debug.Log("net discover - starting as host");
            if (m_HostId != -1 || m_Running)
            {
